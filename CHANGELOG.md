...
## [0.11.0](https://github.com/ghchinoy/watcher/compare/agent_watcher-v0.10.0...agent_watcher-v0.11.0) (2026-07-28)
...
* include rebuild and upgrade recommendations in schema version mismatch error messages ([d451736](https://github.com/ghchinoy/watcher/commit/d451736129f0b47e411c4a26b32df3ddde344183))
...
* support local-behind schema migration detection and add "Fix Common Issues" button ([3f53ffe](https://github.com/ghchinoy/watcher/commit/3f53ffe9cfe22cd52970e294e2f9e1cb13e360b6))
...
* track beads main branch to prevent forward schema skew and add in-app diagnostic versions ([a190301](https://github.com/ghchinoy/watcher/commit/a190301feca0cfca845848789cb65df764df0316))
...
* update macOS Podfile deployment target to 12.0 for Xcode 26 compatibility ([1a508c7](https://github.com/ghchinoy/watcher/commit/1a508c7cee220cf8572e7374b66527bc34734dc0))
